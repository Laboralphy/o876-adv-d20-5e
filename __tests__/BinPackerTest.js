...
describe('applyBinMask', function () {
    it('should close all bins when applying 255 mask', function () {
        ...
        b.resetBins()
        b.applyBinMask(255)
        expect(b.bins.every(b => !b.open)).toBeTruthy()
    })
    it('should close first bin only when applying 1 mask', function () {
        ...
        b.resetBins()
        b.applyBinMask(1)
        expect(b.bins[0].open).toBeFalsy()
        expect(b.bins[1].open).toBeTruthy()
        expect(b.bins[2].open).toBeTruthy()
        expect(b.bins[3].open).toBeTruthy()
    })
    it('should close second bin only when applying 2 mask', function () {
        ...
        b.resetBins()
        b.applyBinMask(2)
        expect(b.bins[0].open).toBeTruthy()
        expect(b.bins[1].open).toBeFalsy()
        expect(b.bins[2].open).toBeTruthy()
        expect(b.bins[3].open).toBeTruthy()
    })
})
